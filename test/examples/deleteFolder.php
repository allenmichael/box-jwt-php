...
$user = $BoxClient->UsersManager->createEnterpriseUser(["name" => "identifyNewUser"], ["avatar_url", "name"]);
...
$copiedFolder = json_decode($copiedFolder->getBody());

$deleteFolderResponse = $userClient->FoldersManager->deleteFolder($copiedFolder->id);
var_dump(json_decode($deleteFolderResponse->getBody()));